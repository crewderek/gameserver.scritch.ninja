    ...
    return function (e) {
        ...
        var r = function () {
            ...
            c = "userAttributes.", h = function () {
                ...
                return r(e, [{
                    key: "getSmallAValue", value: function () {
                        return this.smallAValue
                    }
                }, {
                    key: "getLargeAValue", value: function () {
                        return this.largeAValue
                    }
                }, {
                    key: "generateRandomSmallA", value: function () {
                        var e = o.util.crypto.lib.randomBytes(128).toString("hex"), t = new u.default(e, 16),
                            n = t.mod(this.N);
                        return n
                    }
                }, {
                    key: "generateRandomString", value: function () {
                        return o.util.crypto.lib.randomBytes(40).toString("base64")
                    }
                }, {
                    key: "getRandomPassword", value: function () {
                        return this.randomPassword
                    }
                }, {
                    key: "getSaltDevices", value: function () {
                        return this.SaltToHashDevices
                    }
                }, {
                    key: "getVerifierDevices", value: function () {
                        return this.verifierDevices
                    }
                }, {
                    key: "generateHashDevice", value: function (e, t) {
                        this.randomPassword = this.generateRandomString();
                        var n = "" + e + t + ":" + this.randomPassword, i = this.hash(n),
                    ...
                    key: "hexHash", value: function (e) {
                        return this.hash(new o.util.Buffer(e, "hex"))
                    }
                }, {
                    key: "computehkdf", value: function (e, t) {
                    ...
                    key: "getPasswordAuthenticationKey", value: function (e, t, n, i) {
                        ...
                        var s = "" + this.poolName + e + ":" + t, r = this.hash(s),
                            a = new u.default(this.hexHash(this.padHex(i) + r), 16), l = this.g.modPow(a, this.N),
                    ...
                    key: "getNewPasswordRequiredChallengeUserAttributePrefix", value: function () {
                        return c
                    }
                }, {
                    key: "padHex", value: function (e) {
                        var t = e.toString(16);
        ...
        function f(e) {
            ...
            var n, i = (1 << t) - 1, s = !1, o = "", a = this.t, u = this.DB - a * this.DB % t;
            if (a-- > 0) for (u < this.DB && (n = this[a] >> u) > 0 && (s = !0, o = r(n)); a >= 0;) u < t ? (n = (this[a] & (1 << u) - 1) << t - u, n |= this[--a] >> (u += this.DB - t)) : (n = this[a] >> (u -= t) & i, u <= 0 && (u += this.DB, --a)), n > 0 && (s = !0), s && (o += r(n));
            return s ? o : "0"
        }
        ...
        function C(e, t) {
            var n, i = e % this.DB, s = this.DB - i, r = (1 << s) - 1, o = Math.floor(e / this.DB),
                a = this.s << i & this.DM;
        ...
        function w(e, t) {
            ...
            var i = e % this.DB, s = this.DB - i, r = (1 << i) - 1;
            t[0] = this[n] >> i;
        ...
        function U(e, t, s) {
            ...
            if (!(r.t <= 0)) {
                ...
                null == s && (s = i());
                var a = i(), u = this.s, l = e.s, c = this.DB - m(r[r.t - 1]);
                c > 0 ? (r.lShiftTo(c, a), o.lShiftTo(c, s)) : (r.copyTo(a), o.copyTo(s));
                var h = a.t, f = a[h - 1];
                if (0 != f) {
                    var d = f * (1 << this.F1) + (h > 1 ? a[h - 2] >> this.F2 : 0), v = this.FV / d,
                        g = (1 << this.F1) / d, p = 1 << this.F2, y = s.t, S = y - h, C = null == t ? i() : t;
                    ...
                    for (; --S >= 0;) {
                        ...
                        if ((s[y] += a.am(0, w, s, S, 0, h)) < w) for (a.dlShiftTo(S, C), s.subTo(C, s); s[y] < --w;) s.subTo(C, s)
                    }
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), t.default = n, n.prototype.am = s;
        var j = 26;
        ...
        var H, L, J = "0123456789abcdefghijklmnopqrstuvwxyz", G = new Array;
        ...
        var s = function () {
            ...
            function e() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = t.AccessToken;
                i(this, e), this.jwtToken = n || ""
            }

            return s(e, [{
                key: "getJwtToken", value: function () {
                    return this.jwtToken
                }
            }, {
                key: "getExpiration", value: function () {
                    var e = this.jwtToken.split(".")[1], t = JSON.parse(r.util.base64.decode(e).toString("utf8"));
                    return t.exp
                }
            }]), e
        }();
        ...
        var s = function () {
            ...
            function e() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = t.IdToken;
                i(this, e), this.jwtToken = n || ""
            }
        ...
        var i = function () {
            ...
            function e() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, i = t.RefreshToken;
        ...
        var r = function () {
            ...
            }(), o = n(1), a = n(3), u = i(a), l = n(2), c = i(l), h = n(4), f = i(h), d = n(5), v = i(d), g = n(6),
            m = i(g), p = n(9), y = i(p), S = n(10), C = i(S), w = n(8), k = i(w), A = n(11), T = i(A),
            U = function () {
                function e(t) {
                ...
                return r(e, [{
                    key: "getSignInUserSession", value: function () {
                    ...
                    key: "getAuthenticationFlowType", value: function () {
                        return this.authenticationFlowType
                    }
                }, {
                    key: "setAuthenticationFlowType", value: function (e) {
                        this.authenticationFlowType = e
                    }
                }, {
                    key: "authenticateUser", value: function (e, t) {
                        var n = this, i = new c.default(this.pool.getUserPoolId().split("_")[1]), s = new C.default,
                            r = void 0, a = void 0, l = {};
                        null != this.deviceKey && (l.DEVICE_KEY = this.deviceKey), l.USERNAME = this.username, l.SRP_A = i.getLargeAValue().toString(16), "CUSTOM_AUTH" === this.authenticationFlowType && (l.CHALLENGE_NAME = "SRP_A"), this.client.makeUnauthenticatedRequest("initiateAuth", {
                            ...
                            m({
                                ...
                                if ("NEW_PASSWORD_REQUIRED" === r) {
                                    ...
                                    if (s.ChallengeParameters && (o = JSON.parse(s.ChallengeParameters.userAttributes), a = JSON.parse(s.ChallengeParameters.requiredAttributes)), a) for (var c = 0; c < a.length; c++) u[c] = a[c].substr(l.length);
                    ...
                    key: "authenticateUserInternal", value: function (e, t, n) {
                        var i = this, s = e.ChallengeName, r = e.ChallengeParameters;
                    ...
                    key: "getDeviceResponse", value: function (e) {
                        var t = this, n = new c.default(this.deviceGroupKey), i = new C.default, s = {};
                        s.USERNAME = this.username, s.DEVICE_KEY = this.deviceKey, s.SRP_A = n.getLargeAValue().toString(16), this.client.makeUnauthenticatedRequest("respondToAuthChallenge", {
                            ...
                            var a = r.ChallengeParameters, l = new u.default(a.SRP_B, 16),
                    ...
                    key: "confirmRegistration", value: function (e, t, n) {
                    ...
                    key: "sendCustomChallengeAnswer", value: function (e, t) {
                        var n = this, i = {};
                    ...
                    key: "sendMFACode", value: function (e, t) {
                        var n = this, i = {};
                    ...
                    key: "changePassword", value: function (e, t, n) {
                    ...
                    key: "disableMFA", value: function (e) {
                        if (null == this.signInUserSession || !this.signInUserSession.isValid()) return e(new Error("User is not authenticated"), null);
                        var t = [];
                    ...
                    key: "deleteUser", value: function (e) {
                        var t = this;
                        return null != this.signInUserSession && this.signInUserSession.isValid() ? void this.client.makeUnauthenticatedRequest("deleteUser", {AccessToken: this.signInUserSession.getAccessToken().getJwtToken()}, function (n) {
                            return n ? e(n, null) : (t.clearCachedTokens(), e(null, "SUCCESS"))
                        }) : e(new Error("User is not authenticated"), null)
                    }
                }, {
                    key: "updateAttributes", value: function (e, t) {
                    ...
                    key: "getUserAttributes", value: function (e) {
                    ...
                    key: "getMFAOptions", value: function (e) {
                        return null != this.signInUserSession && this.signInUserSession.isValid() ? void this.client.makeUnauthenticatedRequest("getUser", {AccessToken: this.signInUserSession.getAccessToken().getJwtToken()}, function (t, n) {
                            return t ? e(t, null) : e(null, n.MFAOptions)
                        }) : e(new Error("User is not authenticated"), null)
                    }
                }, {
                    key: "deleteAttributes", value: function (e, t) {
                    ...
                    key: "resendConfirmationCode", value: function (e) {
                    ...
                    key: "getSession", value: function (e) {
                        ...
                        var t = "CognitoIdentityServiceProvider." + this.pool.getClientId() + "." + this.username,
                            n = t + ".idToken", i = t + ".accessToken", s = t + ".refreshToken";
                        if (this.storage.getItem(n)) {
                            var r = new v.default({IdToken: this.storage.getItem(n)}),
                                ...
                                u = {IdToken: r, AccessToken: o, RefreshToken: a}, l = new y.default(u);
                    ...
                    key: "refreshSession", value: function (e, t) {
                        var n = this, i = {};
                        i.REFRESH_TOKEN = e.getToken();
                        var s = "CognitoIdentityServiceProvider." + this.pool.getClientId(), r = s + ".LastAuthUser";
                    ...
                    key: "cacheTokens", value: function () {
                        var e = "CognitoIdentityServiceProvider." + this.pool.getClientId(),
                            t = e + "." + this.username + ".idToken", n = e + "." + this.username + ".accessToken",
                            i = e + "." + this.username + ".refreshToken", s = e + ".LastAuthUser";
                    ...
                    key: "cacheDeviceKeyAndPassword", value: function () {
                        var e = "CognitoIdentityServiceProvider." + this.pool.getClientId() + "." + this.username,
                            t = e + ".deviceKey", n = e + ".randomPasswordKey", i = e + ".deviceGroupKey";
                    ...
                    key: "getCachedDeviceKeyAndPassword", value: function () {
                        var e = "CognitoIdentityServiceProvider." + this.pool.getClientId() + "." + this.username,
                            t = e + ".deviceKey", n = e + ".randomPasswordKey", i = e + ".deviceGroupKey";
                    ...
                    key: "clearCachedDeviceKeyAndPassword", value: function () {
                        var e = "CognitoIdentityServiceProvider." + this.pool.getClientId() + "." + this.username,
                            t = e + ".deviceKey", n = e + ".randomPasswordKey", i = e + ".deviceGroupKey";
                        this.storage.removeItem(t), this.storage.removeItem(n), this.storage.removeItem(i)
                    }
                }, {
                    key: "clearCachedTokens", value: function () {
                        var e = "CognitoIdentityServiceProvider." + this.pool.getClientId(),
                            t = e + "." + this.username + ".idToken", n = e + "." + this.username + ".accessToken",
                            i = e + "." + this.username + ".refreshToken", s = e + ".LastAuthUser";
                    ...
                    key: "getCognitoUserSession", value: function (e) {
                        var t = new v.default(e), n = new f.default(e), i = new m.default(e),
                            s = {IdToken: t, AccessToken: n, RefreshToken: i};
                        return new y.default(s)
                    }
                }, {
                    key: "forgotPassword", value: function (e) {
                    ...
                    key: "getAttributeVerificationCode", value: function (e, t) {
                    ...
                    key: "verifyAttribute", value: function (e, t, n) {
                    ...
                    key: "getDevice", value: function (e) {
                    ...
                    key: "forgetSpecificDevice", value: function (e, t) {
                    ...
                    key: "setDeviceStatusNotRemembered", value: function (e) {
                        return null != this.signInUserSession && this.signInUserSession.isValid() ? void this.client.makeUnauthenticatedRequest("updateDeviceStatus", {
                            AccessToken: this.signInUserSession.getAccessToken().getJwtToken(),
                            DeviceKey: this.deviceKey,
                    ...
                    key: "listDevices", value: function (e, t, n) {
                    ...
                    key: "globalSignOut", value: function (e) {
                        var t = this;
                        return null != this.signInUserSession && this.signInUserSession.isValid() ? void this.client.makeUnauthenticatedRequest("globalSignOut", {AccessToken: this.signInUserSession.getAccessToken().getJwtToken()}, function (n) {
        ...
        var i = function () {
            ...
            function e() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, i = t.Name, s = t.Value;
        ...
        var i = function () {
            ...
            function e() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, i = t.IdToken,
                    s = t.RefreshToken, r = t.AccessToken;
        ...
        var i = function () {
            ...
            r = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], o = function () {
                function e() {
                    n(this, e)
                }

                return i(e, [{
                    key: "getNowString", value: function () {
                        var e = new Date, t = r[e.getUTCDay()], n = s[e.getUTCMonth()], i = e.getUTCDate(),
                            o = e.getUTCHours();
                        o < 10 && (o = "0" + o);
                        ...
                        u < 10 && (u = "0" + u);
                        var l = e.getUTCFullYear(), c = t + " " + n + " " + i + " " + o + ":" + a + ":" + u + " UTC " + l;
                        return c
                    }
                }]), e
            }();
        ...
        var i = function () {
            ...
            function e(t) {
                n(this, e);
                var i = t || {}, s = i.ValidationData, r = i.Username, o = i.Password;
            ...
            return i(e, [{
                ...
                key: "getPassword", value: function () {
                    return this.password
                }
            }, {
                key: "getValidationData", value: function () {
        ...
        var r = function () {
        ...
        }(), o = n(12), a = i(o), u = n(7), l = i(u), c = n(11), h = i(c), f = function () {
            function e(t) {
                s(this, e);
                var n = t || {}, i = n.UserPoolId, r = n.ClientId;
            ...
            return r(e, [{
                key: "getUserPoolId", value: function () {
                ...
                key: "signUp", value: function (e, t, n, i, s) {
                    var r = this;
                    this.client.makeUnauthenticatedRequest("signUp", {
                        ...
                        var i = {Username: e, Pool: r}, o = {user: new l.default(i), userConfirmed: n.UserConfirmed};
                        return s(null, o)
                    })
                }
            }, {
